local strings = {
	...
	AOEHELPER_MENU_GENERAL_BUTTON_SETFORCURRENTZONE_TEXT = "für aktuelle Zone festlegen",
	...
	AOEHELPER_MENU_CURRENTZONE_BUTTON_LOAD_TOOLTIP = "läd die Farben die für die Zone gespeichert sind",
	...
	AOEHELPER_MENU_CURRENTZONE_BUTTON_DELETE_WARNING = "dies löscht jegliche einstellung der Farben für diese Zone. Danach werden die Standarrdfarben verwendet.",
