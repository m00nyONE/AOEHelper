local strings = {
	...
	AOEHELPER_MENU_GENERAL_BUTTON_SETFORCURRENTZONE_TEXT = "set for current Zone",
	...
	AOEHELPER_MENU_CURRENTZONE_BUTTON_LOAD_TOOLTIP = "load the currently saved settings from this zone",
